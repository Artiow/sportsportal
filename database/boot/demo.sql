...
insert into lease.playground (id, name, address, phone, rate, opening, closing, cost) values
  ...
  (4, 'Площадка-4', 'Адрес-4', '+7(999)999-99-99', 9, '0001-01-01 08:00:00', '0001-01-01 22:00:00', 190000),
  (5, 'Площадка-5', 'Адрес-5', '+7(999)999-99-99', 8, '0001-01-01 00:00:00', '0001-01-01 00:00:00', 350000);

alter sequence lease.playground_id_seq restart with 6;
