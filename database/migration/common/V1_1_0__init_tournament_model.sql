...
create unique index tour_bundle_parent_id_text_label_uindex
  on tournament.tour_bundle (parent_id, text_label);

create unique index tour_bundle_parent_id_numeric_label_uindex
  on tournament.tour_bundle (parent_id, numeric_label);
